    ...
    public sealed partial class MainPage : Page
    {
        ...
        private async void ReFreshDevicesList()
        {
            await this.Dispatcher.RunAsync(Windows.UI.Core.CoreDispatcherPriority.Normal, async () =>
            {
                ...
                string device1 = RfcommDeviceService.GetDeviceSelector(RfcommServiceId.ObexObjectPush);
        ...
        private async void DeviceSelectionListView_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            bool rightVersion = await BTEngine.Instance.IsCompatibleVersion(BtDevice);
            if (!rightVersion)
            {
